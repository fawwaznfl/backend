...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.providers.pegawais.driver' => 'string',
            'auth.providers.pegawais.model' => 'string',
            ...
            'auth.passwords.pegawais.provider' => 'string',
            'auth.passwords.pegawais.table' => 'string',
            'auth.passwords.pegawais.expire' => 'integer',
            'auth.passwords.pegawais.throttle' => 'integer',
            ...
            'filesystems.links./Users/macbookair/Development/backend/public/storage' => 'string',
...
'auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.pegawais.driver','auth.providers.pegawais.model',
'auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.pegawais.provider',
'auth.passwords.pegawais.table','auth.passwords.pegawais.expire','auth.passwords.pegawais.throttle','auth.password_timeout','cache.default',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/macbookair/Development/backend/public/storage','logging.default','logging.deprecations.channel',
...
'signed','throttle','verified','role.dashboard','company.scope',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','companies.index','companies.store','companies.show','companies.update',
'companies.destroy','roles.index','roles.store','roles.show','roles.update',
'roles.destroy','divisis.index','divisis.store','divisis.show','divisis.update',
'divisis.destroy','pegawais.index','pegawais.store','pegawais.show','pegawais.update',
'pegawais.destroy','lokasis.index','lokasis.store','lokasis.show','lokasis.update',
'lokasis.destroy','shifts.index','shifts.store','shifts.show','shifts.update',
'shifts.destroy','kontrak.index','kontrak.store','kontrak.show','kontrak.update',
'kontrak.destroy','pegawai-keluar.index','pegawai-keluar.store','pegawai-keluar.show','pegawai-keluar.update',
'pegawai-keluar.destroy','dokumen-pegawai.index','dokumen-pegawai.store','dokumen-pegawai.show','dokumen-pegawai.update',
'dokumen-pegawai.destroy','absensi.index',
'absensi.store','absensi.show','absensi.update','absensi.destroy','cuti.index',
'cuti.store','cuti.show','cuti.update','cuti.destroy','dinas-luar.index',
'dinas-luar.store','dinas-luar.show','dinas-luar.update','dinas-luar.destroy','lembur.index',
'lembur.store','lembur.show','lembur.update','lembur.destroy','patroli.index',
'patroli.store','patroli.show','patroli.update','patroli.destroy','kunjungan.index',
'kunjungan.store','kunjungan.show','kunjungan.update','kunjungan.destroy','penugasan.index',
'penugasan.store','penugasan.show','penugasan.update','penugasan.destroy','rapat.index',
'rapat.store','rapat.show','rapat.update','rapat.destroy','shift-mapping.index',
'shift-mapping.store','shift-mapping.show','shift-mapping.update','shift-mapping.destroy','jenis-kinerja.index','jenis-kinerja.store','jenis-kinerja.show',
'jenis-kinerja.update','jenis-kinerja.destroy','target-kinerja.index','target-kinerja.store','target-kinerja.show',
'target-kinerja.update','target-kinerja.destroy','inventory.index','inventory.store','inventory.show',
'inventory.update','inventory.destroy','notifikasi.index','notifikasi.store','notifikasi.show',
'notifikasi.update','notifikasi.destroy','berita.index','berita.store','berita.show',
'berita.update','berita.destroy','kasbon.index','kasbon.store','kasbon.show',
'kasbon.update','kasbon.destroy','kategori-reimbursement.index',
'kategori-reimbursement.store','kategori-reimbursement.show','kategori-reimbursement.update','kategori-reimbursement.destroy','rekap-pengajuan-keuangan.index',
'rekap-pengajuan-keuangan.store','rekap-pengajuan-keuangan.show','rekap-pengajuan-keuangan.update','rekap-pengajuan-keuangan.destroy','tarif-pph.index',
'tarif-pph.store','tarif-pph.show','tarif-pph.update','tarif-pph.destroy','rekap-pajak-pegawai.index',
'rekap-pajak-pegawai.store','rekap-pajak-pegawai.show','rekap-pajak-pegawai.update','rekap-pajak-pegawai.destroy','payrolls.index',
'payrolls.store','payrolls.show','payrolls.update','payrolls.destroy','reimbursement.index','reimbursement.store','reimbursement.show','reimbursement.update',
'reimbursement.destroy','storage.local',);
...
'QUEUE_CONNECTION','CACHE_STORE','CACHE_DRIVER','MEMCACHED_HOST','REDIS_CLIENT',
...
'AWS_USE_PATH_STYLE_ENDPOINT','SANCTUM_STATEFUL_DOMAINS','SESSION_DOMAIN','VITE_APP_NAME',);
